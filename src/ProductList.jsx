...
function ProductList({ onHomeClick }) {
    const dispatch = useDispatch(); //To send item to CartItem
    
    //Declare piece of State named showCart
    const [showCart, setShowCart] = useState(false);


    //Declare piece of State named showPlants
    ...
    //Dispatch action to Redux store to add the product to the Cart
    const handleAddToCart = (item) => {
        console.log("clicked");
        dispatch(addItem(item));
        //Update local state to indicate product is added to cart
